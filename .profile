...
alias mysqldb1="$MSQL_DB1_HOME/bin/mysql --defaults-file=$MSQL_DB1_HOME/config/my.cnf -u root -p"
alias mysqldb2="$MSQL_DB2_HOME/bin/mysql --defaults-file=$MSQL_DB2_HOME/config/my.cnf -u root -p"